  ...
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 pb-2" dir="rtl">
      <div className="flex items-center justify-between mb-3">
        ...
        {/* Scroll Buttons for Laptop/Desktop */}
        <div className="flex items-center gap-1.5">
          <button
            onClick={() => scroll("right")}
            className="w-8 h-8 rounded-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 flex items-center justify-center text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 shadow-sm transition-colors"
            title="السابق"
          >
            ❯
          </button>
      ...
      <div
        ref={scrollRef}
        className="flex items-center gap-3 overflow-x-auto scrollbar-none py-2 no-scrollbar scroll-smooth"
